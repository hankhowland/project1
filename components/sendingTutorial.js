...
class SendTut extends React.Component {
        ...
        if (this.props.display) {
            return (
                <View style={styles.cont}>
                    ...
                    <PanGestureHandler onGestureEvent={this.handleGesture1}>
    ...
    sendMessage = () => {
        ...
        if (correctEmoji == swipeDirection) {
            ...
            if (nextEmoji == undefined) {this.props.exit()};
            this.setState({
                text: 'swipe ' + gestureDict[nextEmoji+'1'] + ' to send a ' + nextEmoji + ' emoji',
